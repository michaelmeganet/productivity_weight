    ...
    <th>Start Date</th>
        ...
        try {
            foreach ($results as $datarow) {
                ...
                $objSQL2 = new SQL($qr2);
                $out_results = $objSQL2->getResultRowArray();
                echo "<font style='background-color:lightgrey'><pre>";
                print_r($out_results);
                echo "</pre></font>\n<br>";
        ...
        echo "Found data = $count; Success Insert = $cntInsOk; Fail Insert = $cntInsErr; Success Update = $cntUpdOk; Error Update = $cntUpdErr; Data no need change = $cntNoChange<br>";
        ?>
